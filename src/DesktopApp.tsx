      ...
      <div className="h-screen bg-linear-to-tr from-green-300 to-teal-600 flex">
            ...
            {selectedTab === TAB.GPU ? (
              <div className="w-full h-full items-center">
                ...
                <div className="flex gap-10 h-1/5 justify-center items-center">
                  <motion.button
                    className="text-3xl text-teal-800 hover:text-green-300 cursor-pointer"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1.0 }}
                    transition={{ delay: 0 }}
                ...
                <div className=" h-2/5 flex justify-center">
                  {tabContent[1] !== null && (
                    <p className="text-teal-800 w-5/6 text-2xl overflow-y-scroll">
                      {tabContent[1]}
                    </p>
                  )}
                </div>
        ...
        >
          <div className="text-teal-950 w-full h-full items-center justify-center flex flex-col text-nowrap">
            ...
            {!hasChangedTab && (
              <h4 className="text-md italic">(click CPU or GPU to explore)</h4>
            )}
          </div>
        </motion.div>
          ...
          <div className="w-full h-full flex flex-col items-center justify-center">
            {selectedTab === TAB.CPU ? (
              <div className="w-full h-full items-center">
                ...
                <div className="flex gap-10 h-1/5 justify-center items-center">
                  <motion.button
                    className="text-3xl text-green-300 hover:text-teal-800 cursor-pointer"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1.0 }}
                    transition={{ delay: 0.4 }}
                ...
                <div className=" h-2/5 flex justify-center">
                  {tabContent[1] !== null && (
                    <p className="w-5/6 text-teal-800 text-2xl overflow-y-scroll">
                      {tabContent[1]}
                    </p>
                  )}
                </div>
